...
namespace DS {
    ...
    bag::size_type bag::erase_all(const value_type &target) {
        size_type index = 0;
    ...
    void bag::delete_at_index(bag::size_type index) {
        //Not needed since this is private function, assert(index < used);
        --used;
