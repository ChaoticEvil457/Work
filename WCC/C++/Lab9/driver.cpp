...
int main() {
  ...
  std::cout << std::boolalpha << isIntegerPalindrome(1221) << std::endl;
  std::cout << std::boolalpha << isIntegerPalindrome(12321) << std::endl;
  std::cout << std::boolalpha << isIntegerPalindrome(-22) << std::endl;
  std::cout << std::boolalpha << isIntegerPalindrome(1) << std::endl;
  std::cout << std::boolalpha << isIntegerPalindrome(123421) << std::endl;
