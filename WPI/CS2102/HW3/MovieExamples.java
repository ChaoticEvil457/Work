...
/*
 * Subtasks:
 * ignoring elements with simulcast = true
 * accumulate elements in a new programme
 * add elements to different parts of the programme depending on showtime
 * Stop at the end of the given list
 */